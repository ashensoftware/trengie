...
export default function ProjectCard({ project }: { project: Proyecto }) {
    return (
        <Link
            ...
            className="group flex flex-col bg-[#1f1f1f] border border-[#3a3a3a] rounded-xl overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_rgba(239,126,36,0.15)] hover:border-orange/60 hover:-translate-y-2 focus-visible:ring-2 focus-visible:ring-orange focus-visible:outline-none"
        >
            ...
            <div className="p-6 sm:p-7 flex flex-col flex-1">
                ...
                <p className="mt-5 text-sm text-white/70 leading-relaxed line-clamp-3">
                    {project.summary}
                </p>
