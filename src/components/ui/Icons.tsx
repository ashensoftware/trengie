...
export const Icons = {
    ...
    Globe: ({ className }: { className?: string }) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12h19.5M12 2.25c2.485 2.485 3.75 5.485 3.75 9.75S14.485 19.015 12 21.5M12 2.25C9.515 4.735 8.25 7.735 8.25 12s1.265 7.265 3.75 9.75" />
        </svg>
    ),
    ...
    ImagePlaceholder: ({ className }: { className?: string }) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
